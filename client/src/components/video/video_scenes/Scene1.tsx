    ...
    >
      <div className="relative mb-16">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -bottom-6 -right-6 bg-red-500 rounded-full p-3 z-20 shadow-[0_0_30px_rgba(255,0,60,0.6)]"
          >
      ...
      <div className="text-center flex flex-col items-center">
        ...
        <motion.div
          ...
          className="bg-slate-900/50 border border-slate-800 p-6 rounded-2xl backdrop-blur-sm max-w-4xl"
        >
