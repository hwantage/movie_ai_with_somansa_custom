...
export function Scene9() {
  return (
    ...
    >
      <div className="flex flex-row items-center gap-[2vw] max-w-6xl w-full px-[2vw]">
        <div className="flex-1 relative">
          <motion.div
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ delay: 0.4, duration: 0.8 }}
            className="w-[22vw] h-[30vh] bg-slate-900 border-2 border-slate-700 rounded-2xl flex flex-col items-center justify-center mx-auto shadow-2xl relative"
          >
        ...
        >
          ...
          <div className="bg-red-500/10 border border-red-500/50 p-[1.5vw] rounded-xl backdrop-blur-sm">
