      ...
      <div className="flex flex-row items-center gap-16 max-w-6xl w-full px-8">
        <div className="flex-1 relative">
          ...
          <motion.div
            ...
            className="absolute top-1/2 -right-16 h-2 bg-blue-500 shadow-[0_0_10px_#3b82f6] -translate-y-1/2 z-0"
          />
          ...
          <motion.div
            ...
            className="absolute top-1/2 -right-20 -translate-y-1/2 bg-red-500 p-3 rounded-full z-10"
          >
